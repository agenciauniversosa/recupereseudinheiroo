...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    { q: "Posso ter mais de um imóvel na planta? Posso recuperar valores de todos?", a: "Sim! Se você comprou múltiplos imóveis na planta e pagou valores indevidos em mais de um contrato, cada caso pode ser analisado e recuperado independentemente. Basta informar todos os imóveis na sua solicitação." },
