import { Shield, DollarSign, Scale, Clock, CheckCircle, ChevronDown, Phone, MessageCircle, ArrowRight, Building2, Users, FileCheck, Gavel, Calculator, Send, Menu, X, Sparkles, TrendingUp, Zap, MapPin } from "lucide-react";
      ...
      <div ref={ref} className="reveal max-w-7xl mx-auto px-6 md:px-8 relative">
        <div className="mb-16 max-w-3xl">
          ...
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-navy leading-[1.05]">
            Construtoras PODEM ESTAR FAZENDO cobranças{" "}
...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    { q: "Posso ter mais de um imóvel na planta? Posso recuperar valores de todos?", a: "Sim! Se você comprou múltiplos imóveis na planta e pagou correção monetária indevida em mais de um contrato, cada caso pode ser analisado e recuperado independentemente. Basta informar todos os imóveis na sua solicitação." },
    ...
    { q: "Existe alguma restrição de valor mínimo ou máximo para solicitar a análise?", a: "Não! Analisamos casos de qualquer valor. Se houve cobrança indevida, independentemente do montante, você pode ter direito à restituição. Desde pequenas quantias até recuperações de milhares de centenas de reais." },
